...
@app.route(f'{BASE_URI}/create_raid/<raid_name>', methods=['PUT'])
def create_raid(raid_name):
    return 'put /create_raid/'

@app.route(f'{BASE_URI}/delete_raid/<raid_name>', methods=['PUT'])
...
@app.route(f'{BASE_URI}/delete_raid/<raid_name>/<disk>', methods=['PUT'])
...
@app.route(f'{BASE_URI}/del_network_interface/<interface_name>', methods=['PUT']):
...
@app.route(f'{BASE_URI}/del_ip_rules/<interface_name>/', methods=['PUT']):
